...
class Article extends Model
{
     ...
     */
    public function scopeFilterBySources($query, $sources): Builder
    {
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeFilterByAuthors($query, $authors): Builder
    {
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeSearchByTitle($query, $search): Builder
    {
     ...
     */
    public function scopeLatestPaginated($query): LengthAwarePaginator
    {
